...
import { idlFactory } from './mapmops.did.js';
export { idlFactory } from './mapmops.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_MAPMOPS;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./mapmops.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the mapmops canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./mapmops.did.js")._SERVICE>}
 */
export const mapmops = createActor(canisterId);
