...
import { idlFactory } from './identidad_backend.did.js';
export { idlFactory } from './identidad_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_IDENTIDAD_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./identidad_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the identidad_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./identidad_backend.did.js")._SERVICE>}
 */
export const identidad_backend = createActor(canisterId);
