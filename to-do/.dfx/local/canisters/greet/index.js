...
import { idlFactory } from './greet.did.js';
export { idlFactory } from './greet.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_GREET;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./greet.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the greet canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./greet.did.js")._SERVICE>}
 */
export const greet = createActor(canisterId);
