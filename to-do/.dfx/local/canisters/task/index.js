...
import { idlFactory } from './task.did.js';
export { idlFactory } from './task.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_TASK;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./task.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the task canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./task.did.js")._SERVICE>}
 */
export const task = createActor(canisterId);
