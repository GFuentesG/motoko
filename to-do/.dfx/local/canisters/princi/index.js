...
import { idlFactory } from './princi.did.js';
export { idlFactory } from './princi.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_PRINCI;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./princi.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the princi canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./princi.did.js")._SERVICE>}
 */
export const princi = createActor(canisterId);
